...
지식을 습득한 후에 구현하는 과정에 익숙해져 있었는데 이번에는 필요한 것들을 공부해가면서 적용하다 보니 더욱더 많이 배울 수 있었습니다.

최근에는 공부를 하면 할수록 배워야 할 게 끝도 없이 늘어나는 느낌이라 조금은 힘들었는데, 구직 전에 간단한 프로젝트를 진행하면서 기본기를 다질 수 있는 기회였습니다.
